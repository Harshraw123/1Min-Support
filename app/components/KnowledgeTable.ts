                ...
                <TableRow key={source.id} className="border-white/10 hover:bg-white/5">
                  <TableCell className="text-white font-medium pl-6 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="max-w-[240px] md:max-w-[360px] truncate">{source.title}</span>
                    </div>
                  </TableCell>
                  <TableCell>
                    <Badge variant="outline" className="text-zinc-400 border-white/10 capitalize font-normal">
                      {source.type}
                    </Badge>
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right pr-6">
                    <div className="flex justify-end gap-1">
                      ...
                      <Button variant="ghost" size="icon" className="h-8 w-8 text-zinc-400 hover:text-destructive">
