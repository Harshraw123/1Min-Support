...
import EmbedCodeConfig from "@/components/dashboard/EmbedCodeConfig";

import { COLOR_PRESETS } from "@/lib/chatbot/chatbotMetaData";
import { AVATAR_PRESETS } from "@/lib/chatbot/chatbotMetaData";
